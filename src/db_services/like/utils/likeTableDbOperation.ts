...
import {
    LikeTable_QUERY as Query,
    LikeTable_PATCH as Body_Patch,
    LikeTable_POST as Body,
    LikeTable_GET as Datum,
    LikeTable_FIND as Data,
} from '../interfaces/likeInterfaces';
import { Like } from '../like.class';

export class LikeTableDbOperations {
    private static _service: Like & ServiceAddons<any>;
    // static _model: Model<Document<any>>;
    static _servicePath = '/Like';

    /**
     * Initialize service
     * @param service - Service value.
     */
    static initializeService(service: Like & ServiceAddons<any>) {
        LikeTableDbOperations._service = service;
        // LikeTableDbOperations._model = service.Model;
    }
    ...
    static async getDataWithPagination({
        ...
        return await LikeTableDbOperations._service
            ._find({
                query: {
                    ...dbQuery,
                    ...specifiedQuery,
